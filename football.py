...
class Person:
    ...
    def __init__(self,t,s):
        global iD #here we declare global thing,- вставляем сюда глобальную переменную, которая была выше
    ...
    if int(input("To continue enter 1, to exit enter any other number"))!=1: #just to stop the games - для остановки матчей
        ...
        while search:
            ...
            if ans=="exit": #to exit this loop
                ...
                print("There is no person with this ID!") #если введено шото непонятное, то пишем, что нету чела с таким ИД
